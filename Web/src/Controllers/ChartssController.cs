...
namespace CodeRabbits.KaoList.Web.Controllers
{
    ...
    public class ChartssController : ControllerBase
    {
        ...
        public ChartssController(KaoListDataContext context, IServiceScopeFactory serviceScopeFactory)
        {
            _context = context;
    ...
    public record ChartItem
    {
        ...
        public ChartdSnippet? Snippet { get; set; } = default!;
    }
